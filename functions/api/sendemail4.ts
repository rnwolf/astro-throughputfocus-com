//https://github.com/eltorio/vue-highcanfly/blob/dev/functions/sendemail.ts
// store these environment variables in Clouflare Pages UI
// MAILJET_API_KEY = 'xxxx';
// MAILJET_API_PWD = 'xxxxxx';
...
export const onRequestPost: PagesFunction<{
  ...
  const hCaptchaResponse =
    (await hCaptchaVerified.json()) as HCaptchaVerifyResponse;
